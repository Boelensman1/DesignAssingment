 ...
 */
var degrees_slider, sliders = 0, degreesbyid = new Object(), prev_degree_sliders, timeout = 0;
$(function() {
    rotate_pie([45, 360]);
    var $container = $('#rotationSliderContainer');
    var $slider = $('.rotationSlider');
    var $degrees = $('#rotationSliderDegrees');
    var offsetX = $('#rotationSliderContainer').offset().left, offsetY = $('#rotationSliderContainer').offset().top;
