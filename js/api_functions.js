...
help_function.overview.number = 4;
...
function show_set_temps()
{
    ...
    myApp.modal({title: 'Set Temperatures',
        text: '<div class="daynight-set-container"><div class="day-set_text">Day temperature<input type="text" id="temp_input_day" class="modal-prompt-input" value="' + temp_day + '"></div>\n\
                <div class="night-set_text">Night temperature<input type="text" id="temp_input_night" class="modal-prompt-input" value="' + temp_night + '"></div></div>',
        buttons: [
            {text: 'Cancel'}, {text: 'Ok',
                onClick: function(modal) {
                    ...
                    {
                        temp_day = String(Math.floor(tmp_day)) + '.' + String(Number(tmp_day).after());
                        temp_night = String(Math.floor(tmp_night)) + '.' + String(Number(tmp_night).after());
                        ...
                        myApp.addNotification({
                            title: 'Temperatures',
                            message: 'Day temperature set to ' + temp_day + '°C and night temperature set to ' + temp_night + '°C',
                            hold: 4000,
                            closeIcon: false
                        });
                    }
